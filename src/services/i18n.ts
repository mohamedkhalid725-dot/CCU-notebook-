...
messages: {
  ...
  noInternet: 'Internet connection is unavailable. Local data remains available.',
},
...
messages: {
  ...
  invalidData: 'تم العثور على بيانات قديمة أو غير مكتملة وتمت معالجتها بأمان.',
  offline: 'أنت غير متصل بالإنترنت حاليًا',
  online: 'تم استعادة الاتصال',
  confirmDelete: 'هل أنت متأكد من حذف هذا المريض؟',
  noInternet: 'لا يوجد اتصال بالإنترنت. بياناتك المحلية ما زالت متاحة.',
},
